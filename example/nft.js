const { createNftCells, transferNftCells, destroyNftCell, lockNftCell } = require('../src/rpc/nft')

const run = async () => {
  // await createNftCells('0xfea81f725af7a5f5b7d676f5f83ffe14b2bb8aa100000003', 1)
  // const nftOutPoints = [
  //   {
